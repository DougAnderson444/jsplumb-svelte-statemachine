...
var AbstractSegment = function() {
  function AbstractSegment2(params) {
    _classCallCheck$1(this, AbstractSegment2);
    this.params = params;
  ...
  _createClass$1(AbstractSegment2, [{
...
var EndpointRepresentation = function() {
  function EndpointRepresentation2(endpoint, params) {
    _classCallCheck(this, EndpointRepresentation2);
  ...
  _createClass(EndpointRepresentation2, [{
    key: "addClass",
    ...
    key: "compute",
    value: function compute5(anchorPoint, orientation, endpointStyle) {
  ...
  return EndpointRepresentation2;
}();
var DotEndpoint = function(_EndpointRepresentati) {
  _inherits(DotEndpoint2, _EndpointRepresentati);
  var _super = _createSuper(DotEndpoint2);
  function DotEndpoint2(endpoint, params) {
    var _this;
    _classCallCheck(this, DotEndpoint2);
    ...
    _defineProperty(_assertThisInitialized(_this), "type", DotEndpoint2.type);
    params = params || {};
...
var DotEndpointHandler = {
  ...
  cls: DotEndpoint,
  compute: function compute2(ep, anchorPoint, orientation, endpointStyle) {
...
var BlankEndpoint = function(_EndpointRepresentati) {
  _inherits(BlankEndpoint2, _EndpointRepresentati);
  var _super = _createSuper(BlankEndpoint2);
  function BlankEndpoint2(endpoint, params) {
    var _this;
    _classCallCheck(this, BlankEndpoint2);
    _this = _super.call(this, endpoint, params);
    _defineProperty(_assertThisInitialized(_this), "type", BlankEndpoint2.type);
    return _this;
  }
  return BlankEndpoint2;
}(EndpointRepresentation);
_defineProperty(BlankEndpoint, "type", "Blank");
var BlankEndpointHandler = {
  type: BlankEndpoint.type,
  cls: BlankEndpoint,
  compute: function compute3(ep, anchorPoint, orientation, endpointStyle) {
  ...
  getParams: function getParams2(ep) {
    return {};
  }
};
var RectangleEndpoint = function(_EndpointRepresentati) {
  _inherits(RectangleEndpoint2, _EndpointRepresentati);
  var _super = _createSuper(RectangleEndpoint2);
  function RectangleEndpoint2(endpoint, params) {
    var _this;
    _classCallCheck(this, RectangleEndpoint2);
    _this = _super.call(this, endpoint, params);
    _defineProperty(_assertThisInitialized(_this), "width", void 0);
    _defineProperty(_assertThisInitialized(_this), "height", void 0);
    _defineProperty(_assertThisInitialized(_this), "type", RectangleEndpoint2.type);
    params = params || {};
    _this.width = params.width || 10;
    _this.height = params.height || 10;
    return _this;
  }
  _createClass(RectangleEndpoint2, null, [{
    key: "_getParams",
...
var RectangleEndpointHandler = {
  ...
  compute: function compute4(ep, anchorPoint, orientation, endpointStyle) {
  ...
  getParams: function getParams3(ep) {
    return {
      width: ep.width,
      height: ep.height
    };
...
var AbstractConnector = function() {
  function AbstractConnector2(connection, params) {
    _classCallCheck(this, AbstractConnector2);
  ...
  _createClass(AbstractConnector2, [{
    ...
    key: "compute",
    value: function compute5(params) {
...
var StraightSegment = function(_AbstractSegment) {
  _inherits(StraightSegment2, _AbstractSegment);
  var _super = _createSuper(StraightSegment2);
  function StraightSegment2(params) {
    var _this;
    _classCallCheck(this, StraightSegment2);
    ...
    _defineProperty(_assertThisInitialized(_this), "type", StraightSegment2.segmentType);
  ...
  return StraightSegment2;
}(AbstractSegment);
_defineProperty(StraightSegment, "segmentType", "Straight");
var StraightConnector = function(_AbstractConnector) {
  _inherits(StraightConnector2, _AbstractConnector);
  var _super = _createSuper(StraightConnector2);
  function StraightConnector2() {
    var _this;
    _classCallCheck(this, StraightConnector2);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _super.call.apply(_super, [this].concat(args));
    _defineProperty(_assertThisInitialized(_this), "type", StraightConnector2.type);
    return _this;
  }
  _createClass(StraightConnector2, [{
    key: "getDefaultStubs",
  ...
  return StraightConnector2;
}(AbstractConnector);
_defineProperty(StraightConnector, "type", "Straight");
var connectorMap = {};
var Connectors = {
  get: function get2(connection, name, params) {
...
var Overlay = function(_EventGenerator) {
  _inherits(Overlay2, _EventGenerator);
  var _super = _createSuper(Overlay2);
  function Overlay2(instance, component, p) {
    var _this;
...
var overlayMap = {};
var OverlayFactory = {
  get: function get3(instance, name, component, params) {
  ...
  register: function register2(name, overlay) {
    overlayMap[name] = overlay;
  }
};
var LabelOverlay = function(_Overlay) {
  _inherits(LabelOverlay2, _Overlay);
  var _super = _createSuper(LabelOverlay2);
  function LabelOverlay2(instance, component, p) {
    var _this;
    _classCallCheck(this, LabelOverlay2);
    ...
    _defineProperty(_assertThisInitialized(_this), "type", LabelOverlay2.type);
...
function _mapType(map2, obj, typeId) {
  for (var i in obj) {
    map2[i] = typeId;
  }
}
...
function _applyTypes(component, params) {
  if (component.getDefaultType) {
    var td = component.getTypeDescriptor(), map2 = {};
    var defType = component.getDefaultType();
    var o = extend({}, defType);
    _mapType(map2, defType, DEFAULT_TYPE_KEY);
    for (var i = 0, j = component._types.length; i < j; i++) {
      ...
      if (tid !== DEFAULT_TYPE_KEY) {
        ...
        if (_t != null) {
          var overrides = /* @__PURE__ */ new Set([CONNECTOR, ANCHOR, ANCHORS]);
    ...
    component.applyType(o, map2);
  }
}
function _removeTypeCssHelper(component, typeIndex) {
  var typeId = component._types[typeIndex], type = component.instance.getType(typeId, component.getTypeDescriptor());
...
var Component = function(_EventGenerator) {
  _inherits(Component2, _EventGenerator);
  var _super = _createSuper(Component2);
  function Component2(instance, params) {
    var _this;
    ...
    _this.clone = function() {
      var o2 = Object.create(_this.constructor.prototype);
      _this.constructor.apply(o2, [instance, params]);
      return o2;
    };
    _this.overlays = {};
  ...
  _createClass(Component2, [{
    ...
    value: function removeType(typeId, params) {
      var _this2 = this;
      var t = _splitType(typeId), _cont = false, _one = function _one2(tt) {
...
var FaceValues;
(function(FaceValues2) {
  FaceValues2["top"] = "top";
  FaceValues2["left"] = "left";
  FaceValues2["right"] = "right";
  FaceValues2["bottom"] = "bottom";
...
var LightweightFloatingAnchor = function() {
  function LightweightFloatingAnchor2(instance, element) {
    _classCallCheck(this, LightweightFloatingAnchor2);
  ...
  _createClass(LightweightFloatingAnchor2, [{
  ...
  return LightweightFloatingAnchor2;
}();
...
function _path(segments, anchorCount) {
  var anchorsPerFace = anchorCount / segments.length, a = [], _computeFace = function _computeFace2(x1, y1, x2, y2, fractionalLength, ox, oy) {
...
function rotate$1(points, amountInDegrees) {
  var o = [], theta2 = amountInDegrees / 180 * Math.PI;
  for (var i = 0; i < points.length; i++) {
    var _x = points[i].x - 0.5, _y = points[i].y - 0.5;
    o.push({
      x: 0.5 + (_x * Math.cos(theta2) - _y * Math.sin(theta2)),
      y: 0.5 + (_x * Math.sin(theta2) + _y * Math.cos(theta2)),
      ox: points[i].ox,
      oy: points[i].oy,
      offx: 0,
      offy: 0,
...
var anchorGenerators = /* @__PURE__ */ new Map();
...
var Connection = function(_Component) {
  _inherits(Connection2, _Component);
  var _super = _createSuper(Connection2);
  function Connection2(instance, params) {
    var _this;
  ...
  _createClass(Connection2, [{
    ...
    value: function applyType(t, typeMap) {
      ...
      _get(_getPrototypeOf(Connection2.prototype), "applyType", this).call(this, t, typeMap);
    ...
    value: function addClass(c, cascade) {
      _get(_getPrototypeOf(Connection2.prototype), "addClass", this).call(this, c);
      if (cascade) {
    ...
    value: function removeClass(c, cascade) {
      _get(_getPrototypeOf(Connection2.prototype), "removeClass", this).call(this, c);
      if (cascade) {
    ...
    key: "setVisible",
    value: function setVisible(v) {
      _get(_getPrototypeOf(Connection2.prototype), "setVisible", this).call(this, v);
      if (this.connector) {
    ...
    key: "destroy",
    value: function destroy() {
      _get(_getPrototypeOf(Connection2.prototype), "destroy", this).call(this);
      this.endpoints = null;
...
var Endpoint = function(_Component) {
  _inherits(Endpoint2, _Component);
  var _super = _createSuper(Endpoint2);
  function Endpoint2(instance, params) {
    var _this;
  ...
  _createClass(Endpoint2, [{
    ...
    value: function setVisible(v, doNotChangeConnections, doNotNotifyOtherEndpoint) {
      _get(_getPrototypeOf(Endpoint2.prototype), "setVisible", this).call(this, v);
    ...
    key: "applyType",
    value: function applyType(t, typeMap) {
      _get(_getPrototypeOf(Endpoint2.prototype), "applyType", this).call(this, t, typeMap);
    ...
    key: "destroy",
    value: function destroy() {
      _get(_getPrototypeOf(Endpoint2.prototype), "destroy", this).call(this);
    ...
    key: "prepareEndpoint",
    value: function prepareEndpoint2(ep, typeId) {
      var endpointArgs = {
    ...
    key: "addClass",
    value: function addClass(clazz, cascade) {
      _get(_getPrototypeOf(Endpoint2.prototype), "addClass", this).call(this, clazz, cascade);
      if (this.endpoint != null) {
    ...
    key: "removeClass",
    value: function removeClass(clazz, cascade) {
      _get(_getPrototypeOf(Endpoint2.prototype), "removeClass", this).call(this, clazz, cascade);
      if (this.endpoint != null) {
...
var UINode = function UINode2(instance, el) {
  _classCallCheck(this, UINode2);
  this.instance = instance;
  this.el = el;
  _defineProperty(this, "group", void 0);
};
var UIGroup = function(_UINode) {
  _inherits(UIGroup2, _UINode);
  var _super = _createSuper(UIGroup2);
  function UIGroup2(instance, el, options) {
    var _this;
    _classCallCheck(this, UIGroup2);
  ...
  _createClass(UIGroup2, [{
    ...
    value: function getGroups() {
      return this.children.filter(function(cg) {
        return cg.constructor === UIGroup2;
      });
    }
  }, {
    key: "getNodes",
...
var GroupManager = function() {
  function GroupManager2(instance) {
    var _this = this;
    _classCallCheck(this, GroupManager2);
    this.instance = instance;
  ...
  _createClass(GroupManager2, [{
    ...
    value: function _collapseConnection(conn, index, group) {
      ...
      if (esgcp == null || etgcp == null || esgcp.id !== etgcp.id) {
        ...
        this.instance.proxyConnection(conn, index, groupEl, function(conn2, index2) {
          return group.getEndpoint(conn2, index2);
        }, function(conn2, index2) {
          return group.getAnchor(conn2, index2);
        });
        return true;
      } else {
        return false;
    ...
    value: function collapseGroup(group) {
      ...
      if (actualGroup.collapseParent == null) {
        ...
        if (actualGroup.proxied) {
          var collapsedConnectionIds = /* @__PURE__ */ new Set();
          var _collapseSet = function _collapseSet2(conns, index) {
    ...
    value: function expandGroup(group, doNotFireEvent) {
      ...
      if (actualGroup.collapseParent == null) {
        ...
        if (actualGroup.proxied) {
          var _expandSet = function _expandSet2(conns, index) {
            for (var i = 0; i < conns.length; i++) {
              var c = conns[i];
          ...
          var _expandNestedGroup = function _expandNestedGroup2(group2, ignoreCollapsedStateForNested) {
            if (ignoreCollapsedStateForNested || group2.collapsed) {
              var _collapseSet = function _collapseSet2(conns, index) {
                for (var i = 0; i < conns.length; i++) {
                  var c = conns[i];
                  _this6._collapseConnection(c, index, group2.collapseParent || group2);
                }
              };
              _collapseSet(group2.connections.source, 0);
              _collapseSet(group2.connections.target, 1);
              forEach(group2.connections.internal, function(c) {
                return c.setVisible(false);
              });
              forEach(group2.getGroups(), function(g) {
                return _expandNestedGroup2(g, true);
              });
            } else {
              _this6.expandGroup(group2, true);
            }
          };
      ...
      if (actualGroup) {
        ...
        var _one = function _one2(el2) {
          ...
          if (currentGroup !== actualGroup) {
            var entry = _this7.instance.manage(el2);
            var elpos = _this7.instance.getOffset(el2);
            ...
            if (currentGroup != null) {
              currentGroup.remove(el2, false, doNotFireEvent, false, actualGroup);
              _this7._updateConnectionsForGroup(currentGroup);
            }
            if (isGroup) {
              actualGroup.addGroup(droppingGroup);
            } else {
              actualGroup.add(el2, doNotFireEvent);
            }
            var handleDroppedConnections = function handleDroppedConnections2(list, index) {
            ...
            _this7.instance.getId(el2);
            var newPosition = {
              x: elpos.x - cpos.x,
              y: elpos.y - cpos.y
            };
            _this7.instance.setPosition(el2, newPosition);
            _this7._updateConnectionsForGroup(actualGroup);
            _this7.instance.revalidate(el2);
            if (!doNotFireEvent) {
              var p = {
                group: actualGroup,
                el: el2,
...
var SelectionBase = function() {
  function SelectionBase2(instance, entries) {
    _classCallCheck(this, SelectionBase2);
    this.instance = instance;
    this.entries = entries;
  }
  _createClass(SelectionBase2, [{
    key: "length",
    get: function get4() {
  ...
  return SelectionBase2;
}();
var EndpointSelection = function(_SelectionBase) {
  _inherits(EndpointSelection2, _SelectionBase);
  var _super = _createSuper(EndpointSelection2);
  function EndpointSelection2() {
    _classCallCheck(this, EndpointSelection2);
    return _super.apply(this, arguments);
  }
  _createClass(EndpointSelection2, [{
    key: "setEnabled",
  ...
  return EndpointSelection2;
}(SelectionBase);
var ConnectionSelection = function(_SelectionBase) {
  _inherits(ConnectionSelection2, _SelectionBase);
  var _super = _createSuper(ConnectionSelection2);
  function ConnectionSelection2() {
    _classCallCheck(this, ConnectionSelection2);
    return _super.apply(this, arguments);
  }
  _createClass(ConnectionSelection2, [{
    key: "setDetachable",
  ...
  return ConnectionSelection2;
}(SelectionBase);
var Transaction = function Transaction2() {
  _classCallCheck(this, Transaction2);
  _defineProperty(this, "affectedElements", /* @__PURE__ */ new Set());
};
...
function rotate(x, y, w, h, r) {
  var center = {
    x: x + w / 2,
    y: y + h / 2
  }, cr = Math.cos(r / 360 * Math.PI * 2), sr = Math.sin(r / 360 * Math.PI * 2), _point = function _point2(x2, y2) {
    return {
      x: center.x + Math.round((x2 - center.x) * cr - (y2 - center.y) * sr),
      y: center.y + Math.round((y2 - center.y) * cr - (x2 - center.x) * sr)
    };
  };
...
var entryComparator = function entryComparator2(value, arrayEntry) {
  var c = 0;
...
var reverseEntryComparator = function reverseEntryComparator2(value, arrayEntry) {
...
var Viewport = function(_EventGenerator) {
  _inherits(Viewport2, _EventGenerator);
  var _super = _createSuper(Viewport2);
  function Viewport2(instance) {
    var _this;
    ...
    _defineProperty(_assertThisInitialized(_this), "_elementMap", /* @__PURE__ */ new Map());
    _defineProperty(_assertThisInitialized(_this), "_transformedElementMap", /* @__PURE__ */ new Map());
...
var ConnectionDragSelector = function() {
  function ConnectionDragSelector2(selector, def) {
    var exclude = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
    _classCallCheck(this, ConnectionDragSelector2);
  ...
  _createClass(ConnectionDragSelector2, [{
    key: "setEnabled",
  ...
  return ConnectionDragSelector2;
}();
var REDROP_POLICY_STRICT = "strict";
var REDROP_POLICY_ANY = "any";
var SourceSelector = function(_ConnectionDragSelect) {
  _inherits(SourceSelector2, _ConnectionDragSelect);
  var _super = _createSuper(SourceSelector2);
  function SourceSelector2(selector, def, exclude) {
    var _this;
    _classCallCheck(this, SourceSelector2);
  ...
  return SourceSelector2;
}(ConnectionDragSelector);
var TargetSelector = function(_ConnectionDragSelect2) {
  _inherits(TargetSelector2, _ConnectionDragSelect2);
  var _super2 = _createSuper(TargetSelector2);
  function TargetSelector2(selector, def, exclude) {
    var _this2;
    _classCallCheck(this, TargetSelector2);
...
var LightweightRouter = function() {
  function LightweightRouter2(instance) {
    var _this = this;
    _classCallCheck(this, LightweightRouter2);
    this.instance = instance;
    _defineProperty(this, "anchorLists", /* @__PURE__ */ new Map());
    _defineProperty(this, "anchorLocations", /* @__PURE__ */ new Map());
    instance.bind(EVENT_INTERNAL_CONNECTION_DETACHED, function(p) {
  ...
  _createClass(LightweightRouter2, [{
    ...
    value: function _placeAnchors(elementId, _anchorLists) {
      var _this2 = this;
      var cd = this.instance.viewport.getPosition(elementId), placeSomeAnchors = function placeSomeAnchors2(desc, element, unsortedConnections, isHorizontal, otherMultiplier, orientation) {
    ...
    value: function _updateAnchorList(lists, theta2, order, conn, aBoolean, otherElId, idx, reverse, edgeId, connsToPaint, endpointsToPaint) {
    ...
    value: function redraw(elementId, timestamp, offsetToUI) {
      var _this3 = this;
      var connectionsToPaint = /* @__PURE__ */ new Set(), endpointsToPaint = /* @__PURE__ */ new Set(), anchorsToUpdate = /* @__PURE__ */ new Set();
      if (!this.instance._suspendDrawing) {
        ...
        endpointsToPaint.forEach(function(ep2) {
          var cd = _this3.instance.viewport.getPosition(ep2.elementId);
          _this3.instance._paintEndpoint(ep2, {
            timestamp,
            offset: cd
          });
        });
    ...
    value: function _calculateOrientation(sourceId, targetId, sd, td, sourceAnchor, targetAnchor, sourceRotation, targetRotation) {
      ...
      var theta2 = Math.atan2(td.c.y - sd.c.y, td.c.x - sd.c.x), theta22 = Math.atan2(sd.c.y - td.c.y, sd.c.x - td.c.x);
      var candidates = [], midpoints = {};
      (function(types, dim) {
        for (var i2 = 0; i2 < types.length; i2++) {
          var _midpoints$types$i;
          midpoints[types[i2]] = (_midpoints$types$i = {}, _defineProperty(_midpoints$types$i, LEFT, {
            x: dim[i2][0].x,
            y: dim[i2][0].c.y
          }), _defineProperty(_midpoints$types$i, RIGHT, {
            x: dim[i2][0].x + dim[i2][0].w,
            y: dim[i2][0].c.y
            ...
            x: dim[i2][0].c.x,
            y: dim[i2][0].y + dim[i2][0].h
          }), _midpoints$types$i);
          if (dim[i2][1] != null && dim[i2][1].length > 0) {
            for (var axis in midpoints[types[i2]]) {
              midpoints[types[i2]][axis] = _this4.instance._applyRotationsXY(midpoints[types[i2]][axis], dim[i2][1]);
            }
          }
        }
...
function prepareList(instance, input, doNotGetIds) {
  var r = [];
  var _resolveId = function _resolveId2(i) {
    if (isString(i)) {
      return i;
    } else {
...
var JsPlumbInstance = function(_EventGenerator) {
  _inherits(JsPlumbInstance2, _EventGenerator);
  var _super = _createSuper(JsPlumbInstance2);
  function JsPlumbInstance2(_instanceIndex, defaults) {
    var _this;
    _classCallCheck(this, JsPlumbInstance2);
    _this = _super.call(this);
    ...
    _defineProperty(_assertThisInitialized(_this), "endpointsByUUID", /* @__PURE__ */ new Map());
    ...
    _defineProperty(_assertThisInitialized(_this), "_connectionTypes", /* @__PURE__ */ new Map());
    _defineProperty(_assertThisInitialized(_this), "_endpointTypes", /* @__PURE__ */ new Map());
  ...
  _createClass(JsPlumbInstance2, [{
    ...
    key: "getId",
    value: function getId(element, uuid2) {
      if (element == null) {
        return null;
      }
    ...
    value: function getConnections(options, flat) {
      ...
      var scope = options.scope || this.defaultScope, scopes = prepareList(this, scope, true), sources = prepareList(this, options.source), targets = prepareList(this, options.target), results = !flat && scopes.length > 1 ? {} : [], _addOne = function _addOne2(scope2, obj) {
    ...
    value: function selectEndpoints(params) {
      ...
      for (var _el2 in this.endpointsByElement) {
        ...
        if (either || source || target) {
          inner:
            for (var i = 0, ii = this.endpointsByElement[_el2].length; i < ii; i++) {
    ...
    key: "rotate",
    value: function rotate2(element, rotation, _doNotRepaint) {
    ...
    value: function _getRotations(elementId) {
      ...
      var rotations = [];
      var entry = this._managedElements[elementId];
      var _oneLevel = function _oneLevel2(e) {
        if (e.group != null) {
    ...
    value: function repaint(el, timestamp, offsetsWereJustCalculated) {
      ...
      var _mergeRedraw = function _mergeRedraw2(r2) {
    ...
    value: function unregisterEndpoint(endpoint) {
      var uuid2 = endpoint.getUuid();
      if (uuid2) {
        this.endpointsByUUID["delete"](uuid2);
      }
    ...
    key: "getEndpoint",
    value: function getEndpoint(uuid2) {
      return this.endpointsByUUID.get(uuid2);
    }
  }, {
    key: "setEndpointUuid",
    value: function setEndpointUuid(endpoint, uuid2) {
      if (endpoint.uuid) {
        this.endpointsByUUID["delete"](endpoint.uuid);
      }
      endpoint.uuid = uuid2;
      this.endpointsByUUID.set(uuid2, endpoint);
    }
  }, {
    key: "connect",
    ...
    value: function _setVisible(el, state, alsoChangeEndpoints) {
      ...
      if (alsoChangeEndpoints) {
        endpointFunc = function endpointFunc2(ep) {
    ...
    value: function _paintEndpoint(endpoint, params) {
      function findConnectionToUseForDynamicAnchor(ep) {
        ...
        if (params.elementWithPrecedence != null) {
          for (var i2 = 0; i2 < ep.connections.length; i2++) {
            if (ep.connections[i2].sourceId === params.elementWithPrecedence || ep.connections[i2].targetId === params.elementWithPrecedence) {
              idx = i2;
              break;
            }
          }
...
var ArcSegment = function(_AbstractSegment) {
  _inherits(ArcSegment2, _AbstractSegment);
  var _super = _createSuper(ArcSegment2);
  function ArcSegment2(params) {
    var _this;
    _classCallCheck(this, ArcSegment2);
    _this = _super.call(this, params);
    _defineProperty(_assertThisInitialized(_this), "type", ArcSegment2.segmentType);
...
var ArrowOverlay = function(_Overlay) {
  _inherits(ArrowOverlay2, _Overlay);
  var _super = _createSuper(ArrowOverlay2);
  function ArrowOverlay2(instance, component, p) {
    var _this;
    _classCallCheck(this, ArrowOverlay2);
    _this = _super.call(this, instance, component, p);
    _this.instance = instance;
    _this.component = component;
    _defineProperty(_assertThisInitialized(_this), "width", void 0);
    ...
    _defineProperty(_assertThisInitialized(_this), "paintStyle", void 0);
    _defineProperty(_assertThisInitialized(_this), "type", ArrowOverlay2.type);
    _defineProperty(_assertThisInitialized(_this), "cachedDimensions", void 0);
    p = p || {};
...
var PlainArrowOverlay = function(_ArrowOverlay) {
  _inherits(PlainArrowOverlay2, _ArrowOverlay);
  var _super = _createSuper(PlainArrowOverlay2);
  function PlainArrowOverlay2(instance, component, p) {
    var _this;
    _classCallCheck(this, PlainArrowOverlay2);
    _this = _super.call(this, instance, component, p);
    _this.instance = instance;
    _defineProperty(_assertThisInitialized(_this), "type", PlainArrowOverlay2.type);
    _this.foldback = 1;
    return _this;
  }
  return PlainArrowOverlay2;
}(ArrowOverlay);
...
var DiamondOverlay = function(_ArrowOverlay) {
  _inherits(DiamondOverlay2, _ArrowOverlay);
  var _super = _createSuper(DiamondOverlay2);
  function DiamondOverlay2(instance, component, p) {
    var _this;
    _classCallCheck(this, DiamondOverlay2);
    _this = _super.call(this, instance, component, p);
    _this.instance = instance;
    _defineProperty(_assertThisInitialized(_this), "type", DiamondOverlay2.type);
    _this.length = _this.length / 2;
    _this.foldback = 2;
    return _this;
  }
  return DiamondOverlay2;
}(ArrowOverlay);
...
var CustomOverlay = function(_Overlay) {
  _inherits(CustomOverlay2, _Overlay);
  var _super = _createSuper(CustomOverlay2);
  function CustomOverlay2(instance, component, p) {
    var _this;
    _classCallCheck(this, CustomOverlay2);
    _this = _super.call(this, instance, component, p);
    _this.instance = instance;
    _this.component = component;
    _defineProperty(_assertThisInitialized(_this), "create", void 0);
    _defineProperty(_assertThisInitialized(_this), "type", CustomOverlay2.type);
    _this.create = p.create;
    return _this;
  }
  _createClass(CustomOverlay2, [{
    key: "updateFrom",
    value: function updateFrom(d) {
    }
  }]);
  return CustomOverlay2;
}(Overlay);
