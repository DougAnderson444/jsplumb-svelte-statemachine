import { cls, att, UNDEFINED, SELECTOR_MANAGED_ELEMENT, CLASS_CONNECTOR, CLASS_ENDPOINT, ATTRIBUTE_GROUP, CLASS_OVERLAY, EVENT_ZOOM, ATTRIBUTE_NOT_DRAGGABLE, FALSE as FALSE$1, SOURCE, TARGET, INTERCEPT_BEFORE_DRAG, INTERCEPT_BEFORE_START_DETACH, ATTRIBUTE_SCOPE_PREFIX, REDROP_POLICY_ANY, CHECK_DROP_ALLOWED, classList, EVENT_MAX_CONNECTIONS, IS_DETACH_ALLOWED, CHECK_CONDITION, INTERCEPT_BEFORE_DETACH, ABSOLUTE, NONE, Connection, Endpoint, Overlay, TRUE as TRUE$1, BLOCK, STATIC, FIXED, ATTRIBUTE_MANAGED, isLabelOverlay, isArrowOverlay, isDiamondOverlay, isPlainArrowOverlay, isCustomOverlay, EndpointRepresentation, JsPlumbInstance, DotEndpoint, RectangleEndpoint, BlankEndpoint, WILDCARD, ATTRIBUTE_TABINDEX, createFloatingAnchor } from "./jsplumb.core.es-0ce3d9c6.js";
import { isString, forEach, fastTrim, removeWithFunction, uuid, snapToGrid, extend, findWithFunction, wrap, getWithFunction, getFromSetWithFunction, merge, each, getAllWithFunction, intersects, functionChain, isObject, addToDictionary, fromArray, isFunction, log, isAssignableFrom } from "./jsplumb.util.es-fcf8a180.js";
...
function _setClassName(el, cn, classList2) {
  cn = fastTrim(cn);
...
function _classManip(el, classesToAdd, classesToRemove) {
  ...
  var _oneSet = function _oneSet2(add, classes) {
...
function addClass(el, clazz) {
  var _one = function _one2(el2, clazz2) {
    if (el2 != null && clazz2 != null && clazz2.length > 0) {
      if (el2.classList) {
        var parts = fastTrim(clazz2).split(/\s+/);
  ...
  if (isNodeList(el)) {
    forEach(el, function(el2) {
      return _one(el2, clazz);
    });
  } else {
    _one(el, clazz);
  }
  ...
  var _one = function _one2(el2, clazz2) {
    if (el2 != null && clazz2 != null && clazz2.length > 0) {
      if (el2.classList) {
        ...
        if (_this.hasClass(el2, clazz2)) {
          _this.removeClass(el2, clazz2);
        } else {
          _this.addClass(el2, clazz2);
        }
      }
    }
  };
...
function createElementNS(ns2, tag, style, clazz, atts) {
  var e = ns2 == null ? document.createElement(tag) : document.createElementNS(ns2, tag);
  var i;
  style = style || {};
  for (i in style) {
    e.style[i] = style[i];
...
var DefaultHandler = function DefaultHandler2(obj, evt, fn, children, options) {
...
var TapHandler = function() {
  function TapHandler2() {
    _classCallCheck(this, TapHandler2);
  }
  _createClass(TapHandler2, null, [{
    key: "generate",
      ...
      return function(obj, evt, fn, children) {
        if (evt == EVENT_CONTEXTMENU && isMouseDevice)
          ...
          if (obj.__taTapHandler == null) {
            ...
            }, clearSingle = function clearSingle2() {
              tt.down = false;
            }, clearDouble = function clearDouble2() {
              tt.taps = 0;
            };
...
var MouseEnterExitHandler = function() {
  function MouseEnterExitHandler2() {
    _classCallCheck(this, MouseEnterExitHandler2);
  }
  _createClass(MouseEnterExitHandler2, null, [{
    key: "generate",
  ...
  return MouseEnterExitHandler2;
}();
var EventManager = function() {
  function EventManager2(params) {
  ...
  _createClass(EventManager2, [{
    ...
    value: function trigger(el, event, originalEvent, payload, detail) {
      ...
      _each$1(el, function(_el) {
        ...
        var _decorate = function _decorate2(_evt) {
          if (payload) {
            _evt.payload = payload;
          }
        };
        var eventGenerators = {
          "TouchEvent": function TouchEvent(evt2) {
            var touchList = _touchAndList(_el, pl.x, pl.y, sl.x, sl.y, cl.x, cl.y), init = evt2.initTouchEvent || evt2.initEvent;
            init(eventToBind, true, true, window, null, sl.x, sl.y, cl.x, cl.y, false, false, false, false, touchList, touchList, touchList, 1, 0);
          },
          "MouseEvents": function MouseEvents(evt2) {
            evt2.initMouseEvent(eventToBind, true, true, window, detail == null ? 1 : detail, sl.x, sl.y, cl.x, cl.y, false, false, false, false, 1, _el);
          }
        };
...
var _inputFilter = function _inputFilter2(e, el, collicat) {
...
(function(ContainmentType2) {
  ContainmentType2["notNegative"] = "notNegative";
  ContainmentType2["parent"] = "parent";
  ContainmentType2["parentEnclosed"] = "parentEnclosed";
})(ContainmentType || (ContainmentType = {}));
var Drag = function(_Base) {
  _inherits(Drag2, _Base);
  var _super = _createSuper(Drag2);
  function Drag2(el, params, k) {
    var _this;
    ...
    if (params.makeGhostProxy) {
      ...
      _this._ghostProxyFunction = function(el2) {
        if (_this._activeSelectorParams && _this._activeSelectorParams.makeGhostProxy) {
          return _this._activeSelectorParams.makeGhostProxy(el2);
        } else {
  ...
  _createClass(Drag2, [{
    ...
    value: function _trackScroll(e) {
      if (this._moving) {
        ...
        }, dsx = currentScrollValues.x - this._lastScrollValues.x, dsy = currentScrollValues.y - this._lastScrollValues.y, _pos2 = {
          x: dsx + this._lastPosition.x,
          y: dsy + this._lastPosition.y
        }, dx = _pos2.x - this._downAt.x, dy = _pos2.y - this._downAt.y, _z = this._ignoreZoom ? 1 : this.k.getZoom();
    ...
    value: function _moveListener(e) {
      if (this._downAt) {
        ...
        if (this._downAt) {
          var _pos2 = pageLocation(e), dx = _pos2.x - this._downAt.x, dy = _pos2.y - this._downAt.y, _z2 = this._ignoreZoom ? 1 : this.k.getZoom();
          this._lastPosition = {
            x: _pos2.x,
            y: _pos2.y
          };
    ...
    value: function stop(e, force) {
      if (force || this._moving) {
        var positions = [], dPos = _getPosition(this._dragEl);
    ...
    key: "_doConstrain",
    value: function _doConstrain(pos, dragEl, _constrainRect, _size2) {
      if (this._activeSelectorParams != null && this._activeSelectorParams.constrainFunction && typeof this._activeSelectorParams.constrainFunction === "function") {
        return this._activeSelectorParams.constrainFunction(pos, dragEl, _constrainRect, _size2);
      } else {
        return pos;
      }
    }
...
var Collicat = function() {
  function Collicat2(options) {
    _classCallCheck(this, Collicat2);
...
var DragSelection = function() {
  function DragSelection2(instance) {
    _classCallCheck(this, DragSelection2);
    this.instance = instance;
    _defineProperty(this, "_dragSelection", []);
    _defineProperty(this, "_dragSizes", /* @__PURE__ */ new Map());
    _defineProperty(this, "_dragElements", /* @__PURE__ */ new Map());
    _defineProperty(this, "_dragElementStartPositions", /* @__PURE__ */ new Map());
    _defineProperty(this, "_dragElementPositions", /* @__PURE__ */ new Map());
    _defineProperty(this, "__activeSet", void 0);
  }
  _createClass(DragSelection2, [{
    key: "_activeSet",
    get: function get() {
...
var DragManager = function() {
  function DragManager2(instance, dragSelection, options) {
    var _this = this;
    _classCallCheck(this, DragManager2);
    this.instance = instance;
  ...
  _createClass(DragManager2, [{
    ...
    value: function addHandler(handler, dragOptions) {
      ...
      var handlerBeforeStart = (handler.onBeforeStart || function(p) {
      }).bind(handler);
      ...
      if (o.constrainFunction == null && o.containment != null) {
        switch (o.containment) {
          case ContainmentType.notNegative: {
            o.constrainFunction = function(pos, dragEl, _constrainRect, _size2) {
              return {
          ...
          case ContainmentType.parentEnclosed: {
            o.constrainFunction = function(pos, dragEl, _constrainRect, _size2) {
              var x = pos.x < 0 ? 0 : pos.x + _size2.w > _constrainRect.w ? _constrainRect.w - _size2.w : pos.x;
              var y = pos.y < 0 ? 0 : pos.y + _size2.h > _constrainRect.h ? _constrainRect.h - _size2.h : pos.y;
              return {
                x,
                y
              };
...
var ElementDragHandler = function() {
  function ElementDragHandler2(instance, _dragSelection) {
    _classCallCheck(this, ElementDragHandler2);
    this.instance = instance;
    ...
    _defineProperty(this, "_currentDragGroupOffsets", /* @__PURE__ */ new Map());
    _defineProperty(this, "_currentDragGroupSizes", /* @__PURE__ */ new Map());
    _defineProperty(this, "_dragPayload", null);
    _defineProperty(this, "drag", void 0);
    _defineProperty(this, "originalPosition", void 0);
  }
  _createClass(ElementDragHandler2, [{
    key: "onDragInit",
    ...
    value: function onStop(params) {
      ...
      this._dragSelection.each(function(el, id, o3, s, orig) {
        if (el !== params.el) {
          var pp = {
            x: o3.x,
            y: o3.y
    ...
    value: function onDrag(params) {
      ...
      var _one = function _one2(el2, bounds, findIntersectingGroups) {
        if (findIntersectingGroups) {
          var ancestorsOfIntersectingGroups = /* @__PURE__ */ new Set();
        ...
        _this3.instance.setElementPosition(el2, bounds.x, bounds.y);
      ...
      this._dragSelection.updatePositions(finalPos, this.originalPosition, function(el2, id, s, b) {
        _one(el2, b, false);
      });
            ...
            if (isNotInAGroup || membersAreDroppable && isGhostOrNotConstrained) {
              forEach(_this4.instance.groupManager.getGroups(), function(group) {
                ...
                if (group.droppable !== false && group.enabled !== false && _el._jsPlumbGroup !== group && !_this4.instance.groupManager.isDescendant(group, elementGroup)) {
                  var groupEl = group.el, s = _this4.instance.getSize(groupEl), o = _this4.instance.getOffset(groupEl), boundingRect = {
                    x: o.x,
                    y: o.y,
                    w: s.w,
                    h: s.h
              ...
              _this4._groupLocations.sort(function(a2, b) {
                if (_this4.instance.groupManager.isDescendant(a2.group, b.group)) {
                  return -1;
                } else if (_this4.instance.groupManager.isAncestor(b.group, a2.group)) {
                  return 1;
                } else {
                  return 0;
                }
...
var EndpointDragHandler = function() {
  function EndpointDragHandler2(instance) {
    _classCallCheck(this, EndpointDragHandler2);
    this.instance = instance;
  ...
  _createClass(EndpointDragHandler2, [{
    ...
    value: function _mousedownHandler(e) {
      ...
      if (sourceSelector) {
        ...
        if (eventTarget.getAttribute(ATTRIBUTE_JTK_ENABLED) !== FALSE$1) {
          ...
          var payload = {};
          if (def.extract) {
            for (var att2 in def.extract) {
              var v = eventTarget.getAttribute(att2);
              if (v) {
                payload[def.extract[att2]] = v;
              }
            }
    ...
    key: "onDragInit",
    value: function onDragInit(el) {
      var ipco = this.instance.getOffset(el), ips = this.instance.getSize(el);
    ...
    value: function _populateTargets(canvasElement, eventTarget, event) {
      ...
      forEach(matchingEndpoints, function(candidate) {
        if ((_this.jpc != null || candidate !== canvasElement) && candidate !== _this.floatingElement && !candidate.jtk.endpoint.isFull()) {
          if (isSourceDrag && candidate.jtk.endpoint.isSource || !isSourceDrag && candidate.jtk.endpoint.isTarget) {
            var o = _this.instance.getOffset(candidate), s = _this.instance.getSize(candidate);
            boundingRect = {
              x: o.x,
              y: o.y,
              w: s.w,
      ...
      if (isSourceDrag) {
        ...
        if (sourceDef != null) {
          ...
          forEach(targetZones, function(el) {
            if (el.getAttribute(ATTRIBUTE_JTK_ENABLED) !== FALSE$1) {
              ...
              var o = _this.instance.getOffset(d.el), s = _this.instance.getSize(d.el);
              d.r = {
                x: o.x,
                y: o.y,
                w: s.w,
        ...
        targetDefs.forEach(function(targetDef) {
          var targetZones2 = _this.instance.getContainer().querySelectorAll(targetDef.selector);
          forEach(targetZones2, function(el) {
            if (el.getAttribute(ATTRIBUTE_JTK_ENABLED) !== FALSE$1) {
              var scopeFromElement = el.getAttribute(ATTRIBUTE_JTK_SCOPE);
              if (scopeFromElement != null && scopeFromElement !== _this.ep.scope) {
                return;
              ...
              var o = _this.instance.getOffset(el), s = _this.instance.getSize(el);
              d.r = {
                x: o.x,
                y: o.y,
                w: s.w,
    ...
    value: function _getDropEndpoint(p, jpc) {
      ...
      if (this.currentDropTarget.endpoint == null) {
        ...
        if (targetDefinition.def.extract) {
          var tpayload = {};
          for (var att2 in targetDefinition.def.extract) {
            var v = this.currentDropTarget.el.getAttribute(att2);
            if (v) {
              tpayload[targetDefinition.def.extract[att2]] = v;
            }
          }
  ...
  return EndpointDragHandler2;
}();
var GroupDragHandler = function(_ElementDragHandler) {
  _inherits(GroupDragHandler2, _ElementDragHandler);
  var _super = _createSuper(GroupDragHandler2);
  function GroupDragHandler2(instance, dragSelection) {
    var _this;
    _classCallCheck(this, GroupDragHandler2);
  ...
  _createClass(GroupDragHandler2, [{
    key: "reset",
    value: function reset() {
  ...
  return GroupDragHandler2;
}(ElementDragHandler);
var HTMLElementOverlay = function() {
  function HTMLElementOverlay2(instance, overlay) {
    _classCallCheck(this, HTMLElementOverlay2);
    this.instance = instance;
    this.overlay = overlay;
    _defineProperty(this, "htmlElementOverlay", void 0);
    this.htmlElementOverlay = overlay;
  }
  _createClass(HTMLElementOverlay2, null, [{
    key: "getElement",
    value: function getElement(o, component, elementCreator) {
      if (o.canvas == null) {
        if (elementCreator && component) {
          o.canvas = elementCreator(component);
          var cls2 = o.instance.overlayClass + " " + (o.cssClass ? o.cssClass : "");
          o.instance.addClass(o.canvas, cls2);
        } else {
        ...
        for (var att2 in o.attributes) {
          o.instance.setAttribute(o.canvas, att2, o.attributes[att2]);
        }
  ...
  return HTMLElementOverlay2;
}();
var SVGElementOverlay = function(_Overlay) {
  _inherits(SVGElementOverlay2, _Overlay);
  var _super = _createSuper(SVGElementOverlay2);
  function SVGElementOverlay2() {
    var _this;
    _classCallCheck(this, SVGElementOverlay2);
  ...
  _createClass(SVGElementOverlay2, null, [{
    key: "ensurePath",
    value: function ensurePath(o) {
      if (o.path == null) {
        ...
        var cls2 = o.instance.overlayClass + " " + (o.cssClass ? o.cssClass : "");
        o.instance.addClass(o.path, cls2);
        o.path.jtk = {
          overlay: o
        };
      }
  ...
  return SVGElementOverlay2;
}(Overlay);
var SvgComponent = function() {
  function SvgComponent2() {
    _classCallCheck(this, SvgComponent2);
  }
  _createClass(SvgComponent2, null, [{
    key: "paint",
    value: function paint(connector, useDivWrapper, paintStyle, extents) {
      if (paintStyle != null) {
        var xy = [connector.x, connector.y], wh = [connector.w, connector.h], p;
        if (extents != null) {
          if (extents.xmin < 0) {
            xy[0] += extents.xmin;
          }
...
var SvgEndpoint = function() {
  function SvgEndpoint2() {
    _classCallCheck(this, SvgEndpoint2);
  }
  _createClass(SvgEndpoint2, null, [{
...
function groupDragConstrain(desiredLoc, dragEl, constrainRect, size2) {
  ...
  if (dragEl._jsPlumbParentGroup && dragEl._jsPlumbParentGroup.constrain) {
    ...
    x = Math.min(x, constrainRect.w - size2.w);
    y = Math.min(y, constrainRect.h - size2.h);
  }
  return {
    x,
    y
...
var BrowserJsPlumbInstance = function(_JsPlumbInstance) {
  _inherits(BrowserJsPlumbInstance2, _JsPlumbInstance);
  var _super = _createSuper(BrowserJsPlumbInstance2);
  function BrowserJsPlumbInstance2(_instanceIndex, defaults) {
    var _this;
    _classCallCheck(this, BrowserJsPlumbInstance2);
    ...
    var _connClick = function _connClick2(event, e) {
    ...
    var _connectorHover = function _connectorHover2(state, e) {
    ...
    var _connectorMouseupdown = function _connectorMouseupdown2(state, e) {
      var el = getEventSource(e).parentNode;
      if (el.jtk && el.jtk.connector) {
    ...
    var _epClick = function _epClick2(event, e, endpointElement) {
      if (!e.defaultPrevented && e._jsPlumbOverlay == null) {
    ...
    var _endpointHover = function _endpointHover2(state, e) {
    ...
    var _endpointMouseupdown = function _endpointMouseupdown2(state, e) {
      var el = getEventSource(e);
      if (el.jtk && el.jtk.endpoint) {
    ...
    var _overlayHover = function _overlayHover2(state, e) {
      var overlayElement = findParent(getEventSource(e), SELECTOR_OVERLAY, this.getContainer(), true);
      var overlay = overlayElement.jtk.overlay;
      if (overlay) {
    ...
    var _elementClick = function _elementClick2(event, e, target) {
      if (!e.defaultPrevented) {
    ...
    var _elementHover = function _elementHover2(state, e) {
  ...
  _createClass(BrowserJsPlumbInstance2, [{
    ...
    value: function getOffset(el) {
      ...
      var out = {
        x: jel.offsetLeft,
        y: jel.offsetTop
      }, op = el !== container && jel.offsetParent !== container ? jel.offsetParent : null, _maybeAdjustScroll = function _maybeAdjustScroll2(offsetParent) {
    ...
    value: function setContainer(newContainer) {
      ...
      _get(_getPrototypeOf(BrowserJsPlumbInstance2.prototype), "setContainer", this).call(this, newContainer);
    ...
    key: "reset",
    value: function reset() {
      _get(_getPrototypeOf(BrowserJsPlumbInstance2.prototype), "reset", this).call(this);
      var container = this.getContainer();
    ...
    value: function destroy() {
      ...
      _get(_getPrototypeOf(BrowserJsPlumbInstance2.prototype), "destroy", this).call(this);
    }
  }, {
    key: "unmanage",
    value: function unmanage(el, removeElement) {
      this.removeFromDragSelection(el);
      _get(_getPrototypeOf(BrowserJsPlumbInstance2.prototype), "unmanage", this).call(this, el, removeElement);
    }
  }, {
    ...
    value: function rotate(element, rotation, doNotRepaint) {
      ...
      if (this._managedElements[elementId]) {
        ...
        return _get(_getPrototypeOf(BrowserJsPlumbInstance2.prototype), "rotate", this).call(this, element, rotation, doNotRepaint);
      }
      return {
        c: /* @__PURE__ */ new Set(),
        e: /* @__PURE__ */ new Set()
    ...
    value: function deleteConnection(connection, params) {
      if (connection != null && connection.deleted !== true) {
        ...
        return _get(_getPrototypeOf(BrowserJsPlumbInstance2.prototype), "deleteConnection", this).call(this, connection, params);
      } else {
        return false;
      }
    }
    ...
    value: function addSourceSelector(selector, params, exclude) {
      ...
      return _get(_getPrototypeOf(BrowserJsPlumbInstance2.prototype), "addSourceSelector", this).call(this, selector, params, exclude);
    }
  }, {
    key: "removeSourceSelector",
    value: function removeSourceSelector(selector) {
      this.removeDragFilter(selector.selector);
      _get(_getPrototypeOf(BrowserJsPlumbInstance2.prototype), "removeSourceSelector", this).call(this, selector);
    }
  }]);
  return BrowserJsPlumbInstance2;
}(JsPlumbInstance);
var CIRCLE = "circle";
...
var RECT = "rect";
var register$1 = function register2() {
...
var register3 = function register4() {
...
//# sourceMappingURL=jsplumb.browser-ui.es-276086c0.js.map
